...
*Response:* ___reef_slope (Wall) and reef_type (Patch) look to have the biggest percentage differences. 1:8 and 0:5. Pollution_risk low has way more MPA sites than control____
...
*Response:* __Our MPA sites might be getting better nutrients than our control sites because they have more exposed reefs__
...
*Response:* _The average increase by weight at MPA sites. How much fatter are the fish in the MPA sites than if it was not an MPA. _
...
*Response:* ___108, 37__

ESS - adjusts for reusing control sites. "Effective Sample Size" This number basically means that we're reusing the same control over and over.

**Q6.** Find the covariate with the largest standardized mean difference (SMD) *after matching*. Which covariate is it?

*Response:* ____dist_to_deep_water___

SMD can be worse (larger) after matching
...
*Response:* __MPAs have a greater effect in key fishy zones. We expect that in fisheries that there would be 108 kg/ha more fish in MPAs than if those zones weren't MPAs__

**Q8.** What is the biggest remaining threat to causal interpretation of regression coefficients after matching?

*Response:* __We cant be sure that we got all the covariates. Dangerous to have confidence in our results because the model is assuming that we addressed everything we need to address. BUt it cannot acocunt for unobserved selection bias.___
...
*Response:* __It got larger by about a factor of two. This suggests that our Fixed Effect was confounding our model. Plot by plot differences or year/year differences were confounding our estimate._
...
*Response:* __If there was an El Nino__
...
*Response:* __Different soil types, or proximity of plots. If there was a pirate camp__
